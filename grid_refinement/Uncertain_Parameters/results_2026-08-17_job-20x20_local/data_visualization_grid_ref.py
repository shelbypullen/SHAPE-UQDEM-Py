...
circle0 = plt.Circle((c3_opt,c2_opt), radius=0.5, color='red', fill=False, linewidth=4)
...
circle1 = plt.Circle((c3_opt,c2_opt), radius=0.5, color='red', fill=False, linewidth=4)
...
circle2 = plt.Circle((c3_opt,c2_opt), radius=0.5, color='red', fill=False, linewidth=4)
