...
axs2[0].set_title("Expectation of $f(c_2, c_3)$")
...
axs2[1].set_title("Standard Deviation of $f(c_2, c_3)$")
...
# save the plot
file_path_fig2 = os.path.join(figure_dir, f"DEM_presentation_{c_nums[-1]}x{c_nums[-1]}.png")
